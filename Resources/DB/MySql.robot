...
Connect
    # Haven't figured out how to use variables for MySql connection string yet
    Connect To Database Using Custom Params  pymysql  database='test', user='root', password='Password', host='localhost', port=13306
...
Insert Record
    ...
    ${insert_command} =  Set Variable  INSERT INTO test.DemoItems (ItemName, FirstName) VALUES ('New Item ${current_date}', '${FIRST_NAME}')
